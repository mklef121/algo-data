package htable
// to understand this, look up https://blog.fredrb.com/2021/04/01/hashtable-go/ and https://github.com/fredrb/htable
import (
	"encoding/binary"
	"fmt"
	"io"
...
type HashTable[KeyType any] interface {
	Insert (key KeyType, value any)
	Delete (key KeyType)
	Search(key KeyType) (value any)
}
